...
class NmapScanTool:
    ...
    description = "Performs nmap vulnerability scans using --script vuln to detect CVE vulnerabilities"
    
    def __call__(self, target_ip: str, scan_type: str = "vuln") -> str:
        """
...
class CVELookupTool:
    ...
    description = "Looks up CVE vulnerability information from databases"
...
class ReportGeneratorTool:
    ...
    description = "Generates comprehensive vulnerability assessment reports in markdown format"
    
    def __call__(self, scan_data: str, target_ip: str) -> str:
